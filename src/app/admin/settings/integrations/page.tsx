...
export default async function AdminIntegrationSettingsPage() {
  ...
  return <div className="space-y-8 pb-10"><IntegrationSettingsForm initial={initial} publicUrl={platform.publicUrl} keys={["github", "qq", "smtp"]} eyebrow="IDENTITY DELIVERY" title="登录与邮件" description="配置 GitHub、QQ OAuth 与 SMTP 通知服务；敏感凭据只加密保存，不会回传原文。" /><EmailTemplateSettings initial={emailSettings} /></div>;
}
