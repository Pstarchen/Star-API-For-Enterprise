...
import { Activity, Boxes, Building2, Gauge, ScrollText, Settings, ShieldCheck, Users } from "lucide-react";
...
const nav: WorkspaceNavItem[] = [
  ...
  { href: "/admin/tenants", label: "企业租户", icon: Users },
...
export default function AdminLayout({ children }: LayoutProps<"/admin">) {
  return <WorkspaceShell nav={nav} title="平台运营中心" admin>{children}</WorkspaceShell>;
}
