...
export async function GET() {
  try {
    ...
    return Response.json({ status: "ok", service: "star-api-platform", version: "0.1.0", database: "connected", timestamp: new Date().toISOString() }, { headers: { "Cache-Control": "no-store" } });
  } catch {
