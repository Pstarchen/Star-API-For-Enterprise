...
export default async function LoginPage({ searchParams }: PageProps<"/login">) {
  ...
  return <AuthShell title={`登录 ${platform.name}`} description="进入你的个人空间或企业工作区，继续管理接口与调用。"><LoginForm githubEnabled={github.enabled && github.configured} oauthError={typeof oauthError === "string" ? oauthError : undefined} /></AuthShell>;
}
