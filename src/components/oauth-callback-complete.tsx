...
export function OAuthCallbackComplete({ nextPath }: { nextPath: string }) {
  ...
  return <div role="status" className="space-y-4">
    <div className="flex items-start gap-3 rounded-[var(--radius-panel)] border border-[var(--success-line)] bg-[var(--success-soft)] p-4 text-[var(--success)]">
      ...
      <div><strong className="block text-[13px]">GitHub 身份验证完成</strong><p className="mt-1 text-[11px] leading-5">安全会话已经建立，正在进入你的工作空间。</p></div>
    </div>
