...
export function Table({ className, ...props }: React.ComponentProps<"table">) { return <table data-slot="table" className={cn("w-full caption-bottom text-left text-[10px]", className)} {...props} />; }
...
export function TableHead({ className, ...props }: React.ComponentProps<"th">) { return <th data-slot="table-head" className={cn("h-10 whitespace-nowrap px-5 text-[9px] font-semibold", className)} {...props} />; }
