...
export function LoginForm({ passwordLoginEnabled, registrationEnabled, githubEnabled, oauthError }: { passwordLoginEnabled: boolean; registrationEnabled: boolean; githubEnabled: boolean; oauthError?: string }) {
