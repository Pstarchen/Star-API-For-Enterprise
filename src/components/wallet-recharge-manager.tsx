...
type Result = { orderNo: string; channel: PaymentChannelValue; amount: string; paymentUrl: string | null; providerName: string | null; paymentType: string | null; bank: Record<string, unknown> | null; codePay: Record<string, unknown> | null };
